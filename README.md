...
- **SERVER_NAME**: Your MSSQL server name (e.g., `my-server.database.windows.net` for Azure SQL, or `localhost` for local SQL Server)
- **DATABASE_NAME**: Your database name
- **SQL_USER**: SQL Server username for authentication
